...
| Carpeta | Qué es |
|---|---|
| [`database/`](database) | Docker con Mongo (27018) y PostgreSQL (5433) locales, esquema SQL, datos de prueba y vistas. Tutorial: [docs/07](docs/07-tutorial-postgresql-docker.md) |
